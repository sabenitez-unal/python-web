# Prácticas: Python to Access Web Data
...
1. Clona el repositorio `git clone https://github.com/sabenitez-unal/python-web-data.git`
2. Entra a la carpeta clonada `cd python-web-data`
3. Crea el entorno virtual de Python `python3 -m venv .venv`
